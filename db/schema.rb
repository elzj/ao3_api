...
ActiveRecord::Schema.define(version: 2019_10_02_215239) do
  ...
  create_table "admin_blacklisted_emails", force: :cascade do |t|
    t.string "email"
  ...
  create_table "admin_post_taggings", force: :cascade do |t|
  ...
  create_table "archive_faq_translations", force: :cascade do |t|
  ...
  create_table "archive_faqs", force: :cascade do |t|
    t.integer "admin_id"
    t.string "title"
    t.datetime "updated_at"
    t.datetime "created_at"
  ...
  create_table "challenge_claims", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "creation_id"
    t.string "creation_type"
    t.integer "request_signup_id"
  ...
  create_table "challenge_signups", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "pseud_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "collection_participants", force: :cascade do |t|
    t.integer "collection_id"
    t.integer "pseud_id"
  ...
  create_table "collection_preferences", force: :cascade do |t|
    t.integer "collection_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "common_taggings", force: :cascade do |t|
  ...
  create_table "external_author_names", force: :cascade do |t|
  ...
  create_table "external_creatorships", force: :cascade do |t|
    t.integer "creation_id"
    t.string "creation_type"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "external_works", force: :cascade do |t|
    t.string "url", null: false
  ...
  create_table "fannish_next_of_kins", force: :cascade do |t|
    t.integer "user_id"
    t.integer "kin_id"
    t.string "kin_email"
  ...
  create_table "filter_counts", force: :cascade do |t|
  ...
  create_table "filter_taggings", force: :cascade do |t|
    t.bigint "filter_id", null: false
  ...
  create_table "green_prompt_taggings", force: :cascade do |t|
  ...
  create_table "green_prompts", force: :cascade do |t|
  ...
  create_table "inbox_comments", force: :cascade do |t|
    t.integer "user_id"
  ...
  create_table "meta_taggings", force: :cascade do |t|
  ...
  create_table "moderated_works", force: :cascade do |t|
  ...
  create_table "owned_set_taggings", force: :cascade do |t|
  ...
  create_table "owned_tag_sets", force: :cascade do |t|
  ...
  create_table "potential_match_settings", force: :cascade do |t|
  ...
  create_table "prompt_memes", force: :cascade do |t|
    t.integer "prompt_restriction_id"
    t.integer "request_restriction_id"
    t.integer "requests_num_required", default: 1, null: false
  ...
  create_table "prompt_restrictions", force: :cascade do |t|
    t.integer "tag_set_id"
  ...
  create_table "pseuds", force: :cascade do |t|
    t.integer "user_id"
    t.string "name", null: false
    t.text "description"
  ...
  create_table "serial_works", force: :cascade do |t|
    t.integer "series_id"
    t.integer "work_id"
    t.integer "position", default: 1
    t.datetime "created_at"
  ...
  create_table "set_taggings", force: :cascade do |t|
    t.integer "tag_id"
    t.integer "tag_set_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "skin_parents", force: :cascade do |t|
  ...
  create_table "stat_counters", force: :cascade do |t|
    t.integer "work_id"
  ...
  create_table "tag_nominations", force: :cascade do |t|
    t.string "type"
  ...
  create_table "tag_set_associations", force: :cascade do |t|
    t.integer "owned_tag_set_id"
    t.integer "tag_id"
  ...
  create_table "tag_set_nominations", force: :cascade do |t|
    t.integer "pseud_id"
    t.integer "owned_tag_set_id"
    t.datetime "created_at"
    t.datetime "updated_at"
  ...
  create_table "tag_set_ownerships", force: :cascade do |t|
    t.integer "pseud_id"
    t.integer "owned_tag_set_id"
  ...
  create_table "wrangling_guidelines", force: :cascade do |t|
    t.integer "admin_id"
    t.string "title"
    t.text "content"
    t.datetime "created_at"
